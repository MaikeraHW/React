    ...
    <MainTemplate>
      <Container>
        <GenericHTML>
          ...
          <p>
            A Técnica Pomodoro é uma metodologia de produtividade criada por <strong>Francesco Cirillo</strong>, que consiste em dividir o trabalho em blocos de tempo (os famosos "Pomodoros")
            intercalados com pausas. O objetivo é manter o foco total por um período curto e garantir descansos para evitar o cansaço mental.
          </p>
          ...
          <p>
            Você pode configurar o tempo de foco, descanso curto e descanso longo do jeito que quiser! Basta acessar a <a href="/settings">página de configurações</a> e ajustar os minutos como
            preferir.
          </p>
          ...
          <p>
            Todas as suas tarefas e ciclos concluídos ficam salvos no <a href="/history">histórico</a>, com status de completas ou interrompidas. Assim, você consegue acompanhar sua evolução ao longo
            do tempo.
          </p>
